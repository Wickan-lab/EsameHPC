...
int main(int argc, char const *argv[])
{
    ...
    long g_microseconds = generate_end_time.tv_usec -
                          generate_start_time.tv_usec;
    ...
    long c_microseconds = classify_end_time.tv_usec -
                          classify_start_time.tv_usec;
